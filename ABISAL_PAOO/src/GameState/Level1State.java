...
public class Level1State extends GameState {
	...
	public void init() {
		...
		tileMap.loadMap("/Maps/lev1.map");
		tileMap.setPosition(0, 0);
		tileMap.setScroll(1);
		
		bg = new Background("/Backgrounds/for.png", 0.1);
		...
		try {
			...
			Text = ImageIO.read(getClass().getResourceAsStream("/LIFE/level.png"));
